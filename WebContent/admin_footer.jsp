                ...
                <div class="w3_footer_grids">
                    <div class="col-md-4 w3_footer_grid">
                        ...
                        <ul class="address">
                            ...
                            <li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="mailto:info@gmail.com">blood.bank280160@gmail.com</a></li>
                    ...
                    <div class="col-md-4 w3_footer_grid">
                        ...
                        <ul class="info"> 
                            ...
                            <li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="admin_contact.jsp">Contact Us</a></li>
                        </ul>
                    </div>
                    <div class="col-md-4 w3_footer_grid">
                        <h3>Profile</h3>
                        <ul class="info"> 
                            ...
                            <li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="admin_logout.jsp">logout</a></li>
